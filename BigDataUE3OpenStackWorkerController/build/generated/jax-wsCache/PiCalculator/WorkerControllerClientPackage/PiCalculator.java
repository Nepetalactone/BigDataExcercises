...
public interface PiCalculator {
    ...
    @RequestWrapper(localName = "calculatePi", targetNamespace = "http://BigDataUE2Package/", className = "WorkerControllerClientPackage.CalculatePi")
    @ResponseWrapper(localName = "calculatePiResponse", targetNamespace = "http://BigDataUE2Package/", className = "WorkerControllerClientPackage.CalculatePiResponse")
