...
public interface PiCalculator {
    ...
    @RequestWrapper(localName = "calculatePi", targetNamespace = "http://BigDataUE2Package/", className = "bigdataue2package3.CalculatePi")
    @ResponseWrapper(localName = "calculatePiResponse", targetNamespace = "http://BigDataUE2Package/", className = "bigdataue2package3.CalculatePiResponse")
